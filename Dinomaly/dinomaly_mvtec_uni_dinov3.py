...
def dinomaly_dinov2_evaluate(model_path, model_size):
    """
    测试模型
    Args:
        model_path: 模型权重路径
...
def dinomaly_dinov3_train(item_list, model_size="base"):
    """
    训练模型
    Args:
        item_list:
...
def dinomaly_dinov3_evaluate(model_path, model_size="base"):
    """
    测试模型
    Returns:
...
if __name__ == '__main__':
    ...
    dinomaly_dinov2_evaluate(
        model_path="saved_results/vitill_mvtec_uni_dinov2/DinomalyV2_small_carpet_grid_epoch_500_Sat Dec 20 17:07:27 2025.pth",
        model_size="small")

    # # 执行训练
    # dinomaly_dinov3_train(item_list, model_size="small")
    #
    # # 执行测试
    # dinomaly_dinov3_evaluate(
    #     model_path="saved_results/vitill_mvtec_uni_dinov3/DinomalyV3_small_bottle_tile_epoch_1000_Sat Dec 20 17:01:37 2025.pth",
    #     model_size="small")
