...
from hiad.detectors import HRVitAD
...
if __name__ == '__main__':
    ...
    parser.add_argument("--patch_size", default = 384, help='Patch size: size of the image patches after cropping')
    ...
    parser.add_argument("--thumbnail_size", default = 384, help='low-resolution detection resolution')

    parser.add_argument("--thumbnail_config", default = 'configs/vitad.yaml', type=str, help='Low-res(thumbnail) detection model configuration path')
    parser.add_argument("--detector_config_path", default = 'configs/vitad.yaml', type = str, help='High-res detection model configuration path')
    ...
    parser.add_argument("--checkpoint_root", default ='results/vitad_checkpoints', type = str, help='Directory for saving model checkpoints')
    parser.add_argument("--log_root", default = 'results/vitad_logs', type = str, help='Directory for saving logs')
    parser.add_argument("--vis_root", default = 'results/vitad_vis', type = str, help='Directory for saving visualization results')
