...
from hiad.detectors import HRRealNet


if __name__ == '__main__':

    parser = argparse.ArgumentParser(description="High resolution AD")
    ...
    parser.add_argument("--thumbnail_config", default='configs/realnet_thumbnail.yaml', type=str, help='Low-res(thumbnail) detection model configuration path')
    parser.add_argument("--detector_config_path", default = 'configs/realnet_patch.yaml', type = str, help='High-res detection model configuration path')
    ...
    parser.add_argument("--checkpoint_root", default ='results/realnet_checkpoints', type = str, help='Directory for saving model checkpoints')
    parser.add_argument("--log_root", default = 'results/realnet_logs', type = str, help='Directory for saving logs')
    parser.add_argument("--vis_root", default = 'results/realnet_vis', type = str, help='Directory for saving visualization results')
    ...
    if not args.evaluation_only:
        ...
        tasks = SpatialClusteringTaskGenerator(detector_class, config, args.batch_size,
                                               ...
                                               feature_resolution=1, device=args.gpus).create_tasks(
            train_samples, image_indexes)
