...
from hiad.detectors import HRRDPP
...
if __name__ == '__main__':
    ...
    parser.add_argument("--thumbnail_config", default = 'configs/rdpp_thumbnail.yaml', type=str, help='Low-res(thumbnail) detection model configuration path')
    parser.add_argument("--detector_config_path", default = 'configs/rdpp_patch.yaml', type = str, help='High-res detection model configuration path')
    ...
    parser.add_argument("--log_root", default='results/rdpp_logs', type=str, help='Directory for saving logs')
    parser.add_argument("--vis_root", default='results/rdpp_vis', type=str, help='Directory for saving visualization results')
    parser.add_argument("--checkpoint_root", default='results/rdpp_checkpoints', type=str, help='Directory for saving model checkpoints')
