...
import sys
import numpy
import AnomalySoundDetection.BaseASD.ConvolutionalAE.common as com
from AnomalySoundDetection.BaseASD.ConvolutionalAE import keras_model
...
class CAEInterface:
    ...
    def load_model(self):
        ...
        print("============== MODEL LOAD ==============")
        # set model path
        model_file = "AnomalySoundDetection/BaseASD/ConvolutionalAE/model/model_spk.hdf5"
        # load model file
